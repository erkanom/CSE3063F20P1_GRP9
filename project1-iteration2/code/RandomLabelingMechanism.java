...
public class RandomLabelingMechanism extends LabelMechanism {
	...
	private void verifyAndLabel(User user, Label[] choosenLabels, Instance instance, WorkSpace workspace,boolean condition) throws IOException  {	
